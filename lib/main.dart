...
class _HomePageState extends State<HomePage> {
  List surahs = [];
  int lastReadPage = 1; // متغير لحفظ آخر صفحة
  ...
  // دالة لجلب آخر صفحة تم قراءتها من الذاكرة
  ...
  void initState() {
    super.initState();
    readJson();
    loadLastReadPage(); // بنقرأ آخر صفحة أول ما التطبيق يفتح
  }
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async {
          ...
          // بنعمل تحديث للرقم لما نرجع من شاشة القراءة
          loadLastReadPage();
        },
        label: Text(
